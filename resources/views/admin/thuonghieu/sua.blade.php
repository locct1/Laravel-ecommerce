...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            @endif
            <form method="post" action="admin/thuonghieu/sua/{{$thuonghieu->th_id}}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="xx_id">
                        ...
                        <option value="{{$xx->xx_id}}" @if($xx->xx_id==$thuonghieu->xuatxu->xx_id)
                            {{"selected"}}
                            @endif
                            >{{$xx->xx_ten}}
                        </option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="th_ten" placeholder="Nhập tên thương hiệu" value="{{$thuonghieu->th_ten}}">
                </div>
                <div class="form-group">
                    <label class="font-weight-bold">Hình ảnh hiện tại</label>
                    <div class="preview-img-container">
                        <img src="upload/thuonghieu/{{$thuonghieu->th_hinhanh}}" width="200px">
                    </div>
                </div>
                <div class="form-group">
