...
<head>
    ...
    <title>LKshop - Thương mại điện tử điện thoại di động</title>
    <!-- End block title -->
        ...
        <table border="0" width="100%" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <td align="center">
                        <b style="font-size: 2em;">LKshop - Hệ thống bán điện thoại di dộng</b><br />
       ...
       <table border="0" width="100%" cellspacing="0">
        ...
        <table border="1" width="100%" cellspacing="0" cellpadding="5">
            ...
            @foreach($donhang->chitietdonhang as $ct)
                   ...
                   <td align="right" >{{$ct->ct_soluongmua}}</td>
                   <td  align="right">{{number_format($ct->ct_gia, 0, ".", ",").'đ'}}</td>
